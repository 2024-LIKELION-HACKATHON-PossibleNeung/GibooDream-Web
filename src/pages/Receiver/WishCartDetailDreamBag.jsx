...
const WishCartDetail = () => {
    ...
    return (
        <Container>
            ...
            <Content>
                <Title>미래의 <span className='highlight1'>축구선수</span>를 꿈꾸는 <span className='highlight2'>흥민이</span>에게 꿈을 선물하세요</Title>

                <WishList>
                    <WishListTitle>
                        <TextBackgroundUnderLine>꿈을 이루기 위해 필요한 것들</TextBackgroundUnderLine>
                     </WishListTitle>
                ...
                <DreamStory>
                <DreamStoryTitle>
                <TextBackgroundUnderLine>흥민이의 꿈이야기</TextBackgroundUnderLine>
                </DreamStoryTitle>
                    <DreamStoryContainer>
                    <DreamText>
                        안녕하세요, 저는 축구선수를 꿈꾸고 있는 12살 홍민이라고 합니다. 어렸을 때부터 축구를 정말 좋아해서, 축구공만 있으면 시간이 가는 줄 모르고 하루 종일 놀 수 있어요. 제 꿈은 언젠가 대한민국을 대표하는 축구선수가 되어 세계 무대에서 활약하는 것입니다.
                        <br /><br />
                        하지만 요즘 저는 제 꿈을 하기 힘들어졌습니다. 저희 가정 형편이 여단 보지 못하게 되면서, 축구화, 운동복, 축구공 등 준비해야 하는 것이 많이 부족하게 되었습니다. 그래서 축구하는 날이 되면 그냥 헌 운동복 입고, 낡은 유니폼을 착용한 채로 경기에 나가야 하는 것을 많이 상상하고 있습니다.
                        <br /><br />
                        그래서 저는 여러분의 도움을 받고 싶습니다. 여러분의 소중한 기부를 통해 축구화, 유니폼, 그리고 그에 필요한 준비물들을 지원받을 수 있다면, 저는 더 열심히 훈련에 임할 수 있을 것 같아요. 여러분의 응원과 지원이 저에게 큰 힘이 될 것입니다.
                        <br /><br />
                        저는 축구선수가 되기 위해 매일 아침 일찍 일어나서 훈련을 하고, 학교가 끝나면 바로 운동장으로 달려갑니다. 주말에도 축구공을 들고 친구들과 함께 시간을 보내곤 합니다. 제가 가진 열정과 의지를 잃지 않도록, 여러분의 작은 관심과 도움이 절실합니다!
                        <br /><br />
                        기부해주신 꿈물품은 저에게 큰 힘이 될 뿐만 아니라, 저와 같은 꿈을 꾸는 이들에게 큰 도움이 될 것입니다. 축구선수가 되어 여러분께 받은 사랑을 꼭 보답하고 싶습니다. 여러분의 응원과 지원을 기다리고 있겠습니다.
                        <br /><br />
                        감사합니다.
                        <br />
                        축구선수를 꿈꾸는 홍민 올림
                ...
                <Encourage>
                <EncourageTitle>
                <TextBackgroundUnderLine>너의 꿈을 응원해!</TextBackgroundUnderLine>
                </EncourageTitle>
                    <EncourageInput placeholder="응원의 한마디 남겨주세요!" />
            ...
            {showModal && (
                <ModalOverlay>
                    <ModalContent>
                        ...
                        <ModalTotal>
                            <ModalTotalItem>
                                <ModalTotalLabel>꿈바구니 합계</ModalTotalLabel>
